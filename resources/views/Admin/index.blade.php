        ...
        <div class="col-lg-4 col-md-6 col-sm-6" style="padding-top: 20px">
            <div class="card card-stats">
              <div class="card-header card-header-success card-header-icon">
                ...
                <p class="card-category" style="font-weight:bold"> Employees</p>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6"  style="padding-top: 20px">
            <div class="card card-stats">
              <div class="card-header card-header-success card-header-icon">
                ...
                <p class="card-category" style="font-weight:bold"> Users</p>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6" style="padding-top: 20px">
            <div class="card card-stats">
              <div class="card-header card-header-success card-header-icon">
                ...
                <p class="card-category" style="font-weight:bold"> Job</p>
                <h3 class="card-title">2
                </h3>
              </div>
              <div class="card-footer">
                <div class="stats">
                  <a href="#">See All Job</a>
                </div>
              </div>
            </div>
          </div>
